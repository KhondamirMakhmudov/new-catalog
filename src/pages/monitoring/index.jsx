    ...
    showMonitoring(
      {
        ...
        attributes: (prevAttributes) => {
          if (!prevAttributes.includes(attrs)) {
            return [...prevAttributes, attrs];
          }
                ...
                >
                  <g clipPath="url(#clip0_397_16207)">
                    <path
                      ...
                      fill={
                        selectedRegion === "Qoraqalpog'iston"
                          ? "#0256BA"
                          : "#EBF1F9"
                      }
                    />
                    <path
                      ...
                      onMouseLeave={handleMouseLeave}
                      fill={selectedRegion === "Navoiy" ? "#0256BA" : "#EBF1F9"}
                    />
                    <path
                      id="Buxoro"
                      fillRule="evenodd"
                      ...
                      onMouseLeave={handleMouseLeave}
                      fill={selectedRegion === "Buxoro" ? "#0256BA" : "#EBF1F9"}
                    />
                    <path
                      id="Qashqadaryo"
                      fillRule="evenodd"
                      ...
                      onClick={() => {
                        ...
                        onSubmit("Qashqadaryo");
                      }}
                      onMouseEnter={(e) => handleMouseEnter("qashqadaryo", e)}
                      onMouseLeave={handleMouseLeave}
                      fill={
                        selectedRegion === "Qashqadaryo" ? "#0256BA" : "#EBF1F9"
                      }
                    />
                    <path
                      id="Jizzax"
                      ...
                      onMouseLeave={handleMouseLeave}
                      fill={selectedRegion === "Jizzax" ? "#0256BA" : "#EBF1F9"}
                    />
                    <path
                      id="Surxondaryo"
                      fillRule="evenodd"
                      ...
                      onClick={() => {
                        ...
                        onSubmit("Surxondaryo");
                      }}
                      onMouseEnter={(e) => handleMouseEnter("surxondaryo", e)}
                      onMouseLeave={handleMouseLeave}
                      fill={
                        selectedRegion === "Surxondaryo" ? "#0256BA" : "#EBF1F9"
                      }
                    />
                    <path
                      id="Toshkent"
                      ...
                      onMouseLeave={handleMouseLeave}
                      fill={
                        selectedRegion === "Toshkent" ? "#0256BA" : "#EBF1F9"
                      }
                    />
                    <path
                      onClick={() => {
                        handleRegionClick("Toshkent shahar");
                        onSubmit("Toshkent shahri");
                      }}
                      onMouseEnter={(e) => handleMouseEnter("tashkentCity", e)}
                      onMouseLeave={handleMouseLeave}
                      className="cursor-pointer transition-all duration-200"
                      fill={
                        selectedRegion === "Toshkent shahar"
                          ? "#0256BA"
                          : "#EBF1F9"
                      }
                    ...
                    <path
                      ...
                      onMouseLeave={handleMouseLeave}
                      fill={
                        selectedRegion === "Samarqand" ? "#0256BA" : "#EBF1F9"
                      }
                    />
                    <path
                      id="Namangan"
                      ...
                      onMouseLeave={handleMouseLeave}
                      fill={
                        selectedRegion === "Namangan" ? "#0256BA" : "#EBF1F9"
                      }
                    />
                    <path
                      id="Farg'ona"
                      ...
                      onMouseLeave={handleMouseLeave}
                      fill={
                        selectedRegion === "Farg'ona" ? "#0256BA" : "#EBF1F9"
                      }
                    />
                    <path
                      id="Xorazm"
                      ...
                      onMouseLeave={handleMouseLeave}
                      fill={selectedRegion === "Xorazm" ? "#0256BA" : "#EBF1F9"}
                    />
                    <path
                      id="Andijon"
                      fillRule="evenodd"
                      ...
                      onMouseLeave={handleMouseLeave}
                      fill={
                        selectedRegion === "Andijon" ? "#0256BA" : "#EBF1F9"
                      }
                    />
                    <path
                      id="Sirdaryo"
                      ...
                      onMouseLeave={handleMouseLeave}
                      fill={
                        selectedRegion === "Sirdaryo" ? "#0256BA" : "#EBF1F9"
                      }
                    />
                  </g>
                  <defs>
            ...
            <div className="py-[20px] px-[24px] bg-white rounded-br-[12px] rounded-bl-[12px] flex items-center justify-between">
              ...
              <div>
                <Pagination
                  ...
                  page={page}
                  setPage={() => setPage(get(data, "data.page"))}
                />
              </div>
            </div>
          </div>
