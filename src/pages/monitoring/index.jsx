...
const Index = () => {
  ...
  useEffect(() => {
    if ((data, "data.data", [])) {
      const searchResults = get(data, "data.data", []).filter((item) =>
    ...
    <div className="bg-[#F7F7F7] ">
      ...
      <main className="container mb-[46px]">
        ...
        <section>
          ...
          <div className=" bg-white p-[10px] lg:p-[30px] rounded-[20px]">
                ...
                >
                  <g clipPath="url(#clip0_397_16207)">
                    <path
                      ...
                      onClick={() => {
                        // onSubmit("Qoraqalpogiston Respublikasi");
                        handleButtonClick("Qoraqalpogiston Respublikasi");
                        handleRegionClick("Qoraqalpog'iston");
                      }}
                      onMouseEnter={(e) =>
                        handleMouseEnter("qoraqalpogiston", e)
                      }
                    ...
                    <path
                      onClick={() => {
                        ...
                        handleButtonClick("Toshkent shahar");
                      }}
          ...
          <div className="grid grid-cols-12 gap-x-[10px] mt-[24px] font-gilroy">
            <div className="col-span-12 bg-white  border border-[#E0E2F0] rounded-[12px]  relative">
              <Image
              ...
              <input
                ...
                type="text"
                className="w-full pl-[50px] text-sm py-[16px] px-[16px] rounded-[12px]"
          ...
          <div className="font-gilroy bg-white  border border-[#E0E2F0] rounded-[12px] mt-[24px]">
            ...
            <div className="py-[20px] px-[24px] bg-white rounded-br-[12px] rounded-bl-[12px] flex lg:flex-row flex-col gap-[10px] items-center justify-between">
              <div>
                <p className="text-sm text-[#9392A0]">
                  {" "}
                  {get(data, "data.count")} tadan 1-12 tasi ko&apos;rsatilgan
                </p>
              </div>
