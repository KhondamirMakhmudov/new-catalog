...
const Footer = () => {
  return (
    <footer className="container pt-[42px] pb-[12px] px-[42px] rounded-[20px] mt-[4px]">
      <div>
        <div className="grid grid-cols-12">
          ...
          <div className="col-span-2 font-gilroy">
            <ul className="text-[#B9D0EC] text-xs space-y-[8px]">
              <li>
                <h4 className="text-white font-semibold !text-sm">Sahifalar</h4>
              </li>
              <li>
          ...
          <div className="col-span-2 font-gilroy">
            <h4 className="text-sm font-semibold text-white">Murojaat uchun</h4>
